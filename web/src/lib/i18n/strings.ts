...
export const STRINGS = {
	de: {
		...
		'interval.tooltip':
			'Legt fest, ob jeder Kurswert z. B. eine Stunde, einen Tag oder eine Woche abbildet.',
	...
	en: {
		...
		'interval.tooltip':
			'Defines whether each price point represents one hour, one day, or one week.',
		'interval.1h': '1 hour',
		'interval.1d': '1 day',
		'interval.1wk': '1 week',
