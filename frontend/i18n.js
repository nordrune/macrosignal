...
const STRINGS = {
  de: {
    ...
    "strategy.tooltip": "Eine Regel, nach der die App rückwirkend entscheidet: kaufen, verkaufen oder halten. SMA und EMA sind Durchschnittslinien.",
    ...
    "fee.labelLine1": "Gebühr pro Kauf",
    "fee.labelLine2": "Verkauf (%)",
    ...
    "analysis.summary": "{positions} abgeschlossene Positionen, {trades} Aktionen, {days} Tage im Testfenster.",
  ...
  en: {
    ...
    "strategy.tooltip": "A rule the app tests backwards in time: buy, sell, or hold. SMA and EMA are average lines.",
    ...
    "analysis.summary": "{positions} completed positions, {trades} actions, {days} days in the test window.",
